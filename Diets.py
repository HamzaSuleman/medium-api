...
def get_plan(planFileName):
    ...
    for i in range(30):
       ...
       plan.append({
                ...
                'Description_Item2': Snack1['Description Item2'].loc[i],
                ...
                'Description_Item2': Lunch['Description Item2'].loc[i],
                ...
                'Description_Item2': Snack2['Description Item2'].loc[i],
                ...
                'Description_Item2': Dinner['Description Item2'].loc[i],
...
def get_fullplan(planFileName):
    Plan = pd.read_csv('Diet-Plans/'+planFileName+'/'+planFileName+'.csv')
    Total = pd.read_csv('Diet-Plans/'+planFileName+'/Total.csv')
    return {
